...
def correlation_score_matrix_above_threshold(path_ctx, threshold=0):
    ...
    partaking_neurons_per_event_scope1 = np.loadtxt('SynchronousEventParticipatingNeurons/{}'.format(path_ctx).replace("ctx", "cbl"), delimiter=',')    
    partaking_neurons_per_event_scope2 = np.loadtxt('SynchronousEventParticipatingNeurons/{}'.format(path_ctx), delimiter=',')    
