...
def make_graphs(threshold):
    ...
    for path in l:
        ...
        nx.write_gml(my_graph, '/home/romano/mep/ContinuousGlobalSynchrony/Graphs/{}.gml'.format(filename[:-4]))
        ...
        weight_dict = dict(zip(index_named, weights))
        nx.set_edge_attributes(my_graph, weight_dict, "value")
        nx.write_gml(my_graph, '/home/romano/mep/ContinuousGlobalSynchrony/Graphs/{}_cross.gml'.format(filename[:-4]))
