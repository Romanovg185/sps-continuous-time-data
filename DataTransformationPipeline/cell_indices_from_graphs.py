...
def export_indices_correlating_cells():
    loc = '/home/romano/mep/ContinuousGlobalSynchrony/Graphs/'
    target = '/home/romano/mep/ContinuousGlobalSynchrony/Indices/'
    ...
    for my_file in files:
        ...
        cross_cbl = set()
        cross_ctx = set()
        for i, (first, sec) in enumerate(pairs_of_names):
            print(str(i + 1) + '/' + str(len(pairs_of_names)))
